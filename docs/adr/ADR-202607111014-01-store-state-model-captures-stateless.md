...
status: 承認済み
validity: 上書き済み
superseded-by: ADR-202607130831-01-captures-stateless-candidate-side-state, ADR-202607121331-01-captures-bounded-retention-aging
---

# ADR-202607111014-01: 個人 store 状態モデル — captures 無状態化と状態の候補側集約
