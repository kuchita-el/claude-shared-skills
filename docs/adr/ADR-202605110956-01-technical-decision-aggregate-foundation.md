...
status: 承認済み
validity: 上書き済み
superseded-by: ADR-202607112231-01-adr-two-axis-status-validity-model
---

# ADR-202605110956-01: 技術的意思決定集約の運用基盤（採番方式・配置・ライフサイクル・廃止扱い）
...
- Superseded by: ADR-202607112231-01-adr-two-axis-status-validity-model（状態モデル〔4状態・英文表記〕と廃止扱いを2軸分離モデルへ再設計。採番方式・配置は新 ADR が不変で継承）
