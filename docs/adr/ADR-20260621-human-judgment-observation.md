...
関連 Issue [#319](https://github.com/kuchita-el/claude-shared-skills/issues/319) 起票時（2026-06-21）に種別 spike / サイズ Medium / Ready 判定済み。ADR-20260719 決定1 の粒度判定基準4項目すべてに該当（後戻りコスト高・複数モジュール波及・採用理由揮発リスク・自動強制不可）するため ADR 化する。
