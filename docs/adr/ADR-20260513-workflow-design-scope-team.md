...
Related: ADR-20260718-workflow-design-v2-terminology-flow-stock-axes（v2 構造のうち生存する決定群の現行の住処。本ADRは v2 のスコープを限定する補足判定。ADR分割以前は上書き済みの ADR-20260402-workflow-design-v2-structure を指していた）
