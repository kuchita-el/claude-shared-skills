...
| #384 `carrier-promotion-spec.md`（pause 中・未作成） | 再定義 | career ラベルベースのハンドラ入力前提が失効。入力を取り込み Issue の裁定結果へ。#405 確定後に再定義して再開。 |
...
- DESIGN.md 決定事項8 の career 部分・§3-4・#349 D1 参照を本決定に合わせて更新する。
