...
status: 承認済み
validity: 上書き済み
superseded-by: ADR-202606020010-01-principles-rationale-hub
---

# ADR-202605312147-01: workflow-design.md を Explanation 根拠ハブへ縮退（責務再定義）
...
- Superseded by: ADR-202606020010-01-principles-rationale-hub（責務定義を継承し、スコープ文面の曖昧さ＝「広さ」と「原則の射程」の混同を解消）
