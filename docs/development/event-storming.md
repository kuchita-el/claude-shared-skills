...
- アクター #4-a「提案者」・#4-b「承認者」は技術的意思決定の役割を抽象化したアクター。`#4-a` `#4-b` は既存アクター #4「テックリード / チーム」（Issue #130 で削除）の分割継承を表す表記であり、設計判断「ID付与の方針」が抑止する**新規採番**ではない
...
| 提案者 | 技術的意思決定を起案するアクター（ロール抽象化） | |
| 承認者 | 技術的意思決定を承認・廃止・上書きするアクター（ロール抽象化） | |
