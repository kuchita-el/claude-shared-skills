...
```boundary-decision-json
{
  ...
  "graph": [
    {"candidate":"domain-design","path":"plugins/domain-design/skills/domain-modeling/SKILL.md","direction":"outbound","target":"plugins/domain-design/skills/domain-modeling/references/domain-model-notation.md"},
    {"candidate":"domain-design","path":"plugins/domain-design/skills/domain-modeling/SKILL.md","direction":"outbound","target":"plugins/domain-design/skills/domain-modeling/references/domain-modeling-flow.md"},
    {"candidate":"domain-design","path":"plugins/domain-design/skills/event-storming/SKILL.md","direction":"outbound","target":"plugins/domain-design/skills/event-storming/references/big-picture-flow.md"},
    {"candidate":"domain-design","path":"plugins/domain-design/skills/event-storming/SKILL.md","direction":"outbound","target":"plugins/domain-design/skills/event-storming/references/big-picture-template.md"},
    {"candidate":"domain-design","path":"plugins/domain-design/skills/event-storming/SKILL.md","direction":"outbound","target":"plugins/domain-design/skills/event-storming/references/design-level-flow.md"},
    {"candidate":"domain-design","path":"plugins/domain-design/skills/event-storming/SKILL.md","direction":"outbound","target":"plugins/domain-design/skills/event-storming/references/event-storming-template.md"},
    {"candidate":"dependency-insight","path":"plugins/dependency-insight/skills/dependency-check/SKILL.md","direction":"outbound","target":"plugins/dependency-insight/skills/dependency-check/references/npm.md"}
  ]
}
```
