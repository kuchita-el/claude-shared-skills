...
| 変異 | 緑へ転じる負例 |
|---|---|
| 一文の長さの判定を無効化する | 01〜08 |
| 見出しの判定を記号だけに戻す | 04 |
| 括弧の対応の数え上げを無効化する | 03・05 |
| 段落の行の連結を無効化する | 02・07 |
| 括弧の対を丸括弧だけに削る | 05 |
| 半角の疑問符と感嘆符を区切りに加える | 06 |
| インラインコードの内側からも記法の記号を落とす | 08 |
...
| リンク記法の除去を無効化する | 05 |
| 参照形式リンクの除去を無効化する | 15 |
| 文の区切りから疑問符と感嘆符を落とす | 08 |
| インラインコードの伏せ字を無効化する | 09 |
| 字下げのコードブロックの除外を無効化する | 07 |
| チルダのフェンスの認識を落とす | 06 |
| バッククォートのフェンスの認識を落とす | 02 |
| 表の行の除外を無効化する | 11 |
| 引用の行の除外を無効化する | 11 |
| 冒頭のメタデータの除外を無効化する | 12 |
| 箇条書きのマーカー除去を無効化する | 13 |
| 強調の記号の除去を無効化する | 14 |
...
| 変異 | 候補が消える fixture |
|---|---|
| 不透明な識別子の判定を無効化する | 01〜05 |
| 識別子の形から課題番号を落とす | 03 |
| 識別子の判定でインラインコードの囲みを外さない | 02 |
| 骨格位置の助詞から「が」を落とす | 04 |
| 骨格位置の助詞から「を」を落とす | 05 |
