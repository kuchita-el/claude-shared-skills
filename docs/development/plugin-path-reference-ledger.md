...
| scripts/tests/adr-scoping-cases-basic.bats | 1353 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 1370 | plugins/adr | migration | reference | wave-5 | current |
...
| scripts/tests/adr-scoping-cases-basic.bats | 1243 | plugins/adr | migration | reference | issue-619 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 1258 | plugins/adr | migration | reference | issue-620 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 1278 | plugins/adr | migration | reference | issue-620 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 1291 | plugins/adr | migration | reference | issue-624 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 1311 | plugins/adr | migration | reference | issue-624 | current |
