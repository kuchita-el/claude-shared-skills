...
| scripts/tests/adr-scoping-cases-basic.bats | 753 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 767 | plugins/adr | migration | reference | wave-5 | current |
...
| scripts/tests/adr-scoping-cases-basic.bats | 862 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 875 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 901 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 902 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 903 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 926 | plugins/adr | migration | reference | wave-5 | current |
