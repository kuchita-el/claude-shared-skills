...
| scripts/tests/adr-scoping-cases-basic.bats | 54 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 903 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 917 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 936 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 945 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 964 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 973 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 981 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 1042 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 1068 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 1081 | plugins/adr | migration | reference | wave-5 | current |
...
| scripts/tests/adr-scoping-cases-basic.bats | 1362 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 1379 | plugins/adr | migration | reference | wave-5 | current |
...
| scripts/tests/adr-scoping-cases-basic.bats | 1219 | plugins/adr | migration | reference | issue-619 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 1246 | plugins/adr | migration | reference | issue-619 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 1264 | plugins/adr | migration | reference | issue-620 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 1284 | plugins/adr | migration | reference | issue-620 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 1300 | plugins/adr | migration | reference | issue-624 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 1320 | plugins/adr | migration | reference | issue-624 | current |
