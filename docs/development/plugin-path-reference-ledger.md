...
| scripts/tests/adr-scoping-cases-basic.bats | 883 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 912 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 913 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 914 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 937 | plugins/adr | migration | reference | wave-5 | current |
