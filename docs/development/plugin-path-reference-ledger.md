...
| scripts/tests/adr-scoping-cases-basic.bats | 911 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 920 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 938 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 947 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 955 | plugins/adr | migration | reference | wave-5 | current |
...
| scripts/tests/adr-scoping-cases-basic.bats | 1055 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 1084 | plugins/adr | migration | reference | wave-5 | current |
...
| scripts/tests/adr-scoping-cases-basic.bats | 1109 | plugins/adr | migration | reference | wave-5 | current |
