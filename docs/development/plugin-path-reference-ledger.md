...
| scripts/tests/adr-scoping-cases-basic.bats | 806 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 823 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 832 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 850 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 859 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 867 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 928 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 954 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 967 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 996 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 997 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 998 | plugins/adr | migration | reference | wave-5 | current |
| scripts/tests/adr-scoping-cases-basic.bats | 1021 | plugins/adr | migration | reference | wave-5 | current |
