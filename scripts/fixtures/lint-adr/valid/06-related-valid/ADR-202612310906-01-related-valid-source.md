...
- Related: ADR-202701020906-01-related-valid-target-b（先頭stem＝有効。分割以前は上書き済みの ADR-202701030906-01-related-valid-retired-mentioned を指していた＝散文の退役引用は先頭stemでないため誤検出しない）
