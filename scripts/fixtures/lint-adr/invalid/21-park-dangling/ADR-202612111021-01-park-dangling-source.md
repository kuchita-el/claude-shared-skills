...
validity: 有効
---
# ADR-202612111021-01-park-dangling-source: 保留した決定が非存在 slug を指す source
...
- あるfacet を未決のまま残す（想定継承先: [ADR-202612121021-01-park-missing](./ADR-202612121021-01-park-missing.md)）
