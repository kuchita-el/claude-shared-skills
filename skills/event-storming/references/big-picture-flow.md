...
- `docs/context-map.md` — イベントフロー図・コンテキスト一覧・コンテキストマップ・ホットスポット
...
3. コンテキストマップをMermaid記法で可視化し、提示する
...
Phase 1-5の結果を `docs/context-map.md` に出力する。

**進め方:**

1. `docs/` ディレクトリの存在を確認し、なければ `mkdir -p` で作成する
2. `references/context-map-template.md` を読み込み、テンプレートに従って出力する
